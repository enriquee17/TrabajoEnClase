...
public class Caja {
	...
	public static void eliminarArticulo() {
		...
		do {
			...
			if (respuesta.equals("Carniceria") ) {
				...
				Principal.fireArticuloDevueltoListener(evento);
				respuesta = JOptionPane.showInputDialog("Que articulo desea eliminar?\n"
						+ " Lacteos,\n"
						+ " Perfumeria,\n"
						+ " Limpieza,\n"
	...
	public static void pagar () throws CashInsuficienteException {
		...
		float pago = Float.parseFloat(JOptionPane.showInputDialog("Debe pagar " + importe + "\n¿Cuánto dinero desea darme?"));
		
		if (pago < importe) {
			throw new CashInsuficienteException("Debes pagar " + importe + " €. Tu pago es insuficiente");
		}
	}
